...
contract('ERC721Mintable', accounts => {
    ...
    const name = " ST_ERC721MintableToken";
    const symbol = "ST_721M";
    const baseTokenURI = "https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/";
    const zeroAddress = '0x0000000000000000000000000000000000000000';
    let currentOwner;
    let contractInstance;

    describe('Ownable inherited', function () {
        before(async() => { 
    ...
    describe('ERC721Metadata inherited', () =>{
        before(async() => { 
            contractInstance = await ERC721MintableComplete.new(name, symbol, {from: account_one});
        });
    ...
    describe('ERC721 MintableComplete', () => {
